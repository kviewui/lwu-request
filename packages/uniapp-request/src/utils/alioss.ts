...
class UploadAlioss {
  ...
  async getSignature(policy: string, accessKeySecret: string, options: UploadAliossOptions): Promise<string> {
  ...
  uploadFile(filePath: string, dir?: string): Promise<{
    ...
    return new Promise(async (resolve, reject) => {
      ...
      const getUploadTask = uni.uploadFile({
